---
title: Setting up NixOS on my Home Server
...
8. Reboot
   ![Mission Accomplished](./assets/mission-accomplished.png)
...
![Getting to the Admin Area in Gitlab](./assets/gitlab-admin-area.gif)
From here head to "CI/CD" > "Runners" and in the top right you should see a nice shiny "New Instance Runner" button:
![Gitlab Runners Page](./assets/gitlab-runners-page.png)
